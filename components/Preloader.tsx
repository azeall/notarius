    ...
    <div className="pl" aria-hidden>
      ...
      <style>{`
        ...
        .pl-seal{width:92px;height:92px;border-radius:22px;display:grid;place-items:center;
          background:rgb(var(--surface-2-rgb));animation:plPulse 1.1s ease-in-out infinite;}
        .pl-seal span{font-family:var(--font-manrope),system-ui,sans-serif;font-weight:800;font-size:46px;color:rgb(var(--violet-rgb));line-height:1;}
