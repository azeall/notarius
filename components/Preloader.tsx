  ...
  return (
    <div className="pl" aria-hidden>
      ...
      <style>{`
        ...
        .pl-seal span{font-family:var(--font-playfair),Georgia,serif;font-size:44px;color:#c05c2e;line-height:1;}
        @keyframes plOut{to{opacity:0;visibility:hidden;}}
        @keyframes plPulse{0%,100%{transform:scale(1);box-shadow:inset 0 0 0 6px rgba(192,92,46,.08),0 0 0 0 rgba(192,92,46,.28)}
          50%{transform:scale(1.06);box-shadow:inset 0 0 0 6px rgba(192,92,46,.08),0 0 0 16px rgba(192,92,46,0)}}
