...
const STATUS_META: Record<string, { label: string; color: string; bg: string; border: string }> = {
  completed: { label: 'Состоялась', color: 'rgb(var(--ok-2-rgb))', bg: 'rgb(var(--ok-rgb) / 0.14)', border: 'rgb(var(--ok-rgb) / 0.4)' },
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-1.5 mt-3 pt-3" style={{ borderTop: '1px solid rgb(var(--violet-rgb) / 0.10)' }}>
          ...
          <a
            ...
            style={{ color: 'rgb(var(--ok-2-rgb))', border: '1px solid rgb(var(--ok-rgb) / 0.35)' }}
          >
          ...
          {a.status === 'active' ? (
            <>
              <button onClick={() => setStatus('completed')} disabled={busy}
                ...
                style={{ color: 'rgb(var(--ok-2-rgb))', border: '1px solid rgb(var(--ok-rgb) / 0.30)' }}>
                Состоялась
              </button>
