...
export default function AdminAppointmentCard({ a, isAdmin }: { a: Appointment; isAdmin?: boolean }) {
        ...
        {isAdmin && reassigning && (
          <div className="flex items-center gap-1.5 mt-2.5 flex-wrap">
            <select
              ...
              style={{ background: 'rgb(var(--bg-rgb))', border: '1px solid rgba(83,74,183,0.25)' }}
            >
  ...
  // ────────────────────── EDIT ──────────────────────
  return (
    <div className="w-full min-w-0 rounded-2xl px-3 sm:px-6 py-4 sm:py-5" style={{ background: 'rgb(var(--surface-rgb))', border: '2px solid rgba(83,74,183,0.40)' }}>
      {/* Header row */}
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            style={{ background: 'rgb(var(--bg-rgb))', border: '1px solid rgba(83,74,183,0.20)', colorScheme: 'light' }}
          />
          <button type="button" onClick={() => setDate(d => stepWeekday(d, +1))}
            className="w-9 h-9 flex items-center justify-center rounded-md text-cream/70 hover:text-gold transition-colors"
      ...
      <div
        ...
        style={
          !selectionFits || selectionConflicts
            ...
            : changed
              ? { background: 'rgba(83,74,183,0.10)', border: '1px solid rgba(83,74,183,0.3)', color: 'rgb(var(--text-rgb))' }
              : { background: 'rgba(0,0,0,0.03)', border: '1px solid rgba(83,74,183,0.15)', color: 'rgb(var(--muted-rgb))' }
        }
      >
        {!selectionFits
