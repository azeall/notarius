              ...
              <li key={item.label}>
                <button
                  ...
                  style={{
                    ...
                    borderColor: isChecked ? 'rgba(79,157,122,0.40)' : 'rgba(192,92,46,0.12)',
                  }}
                >
                  <span
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${isChecked ? '#4f9d7a' : 'rgba(192,92,46,0.35)'}`,
                    }}
                  >
                    {isChecked && (
                  ...
                  <span className="flex-1 min-w-0">
                    <span className="flex items-center gap-2 flex-wrap">
                      ...
                      {item.optional && (
                        <span className="text-[10px] uppercase tracking-wide font-semibold text-slate rounded px-1.5 py-0.5" style={{ border: '1px solid rgba(192,92,46,0.20)' }}>
                          не для всех
                        </span>
                      )}
                    </span>
        ...
        createPortal(
          <div className="print-sheet">
            <div style={{ fontFamily: 'Georgia, "Times New Roman", serif', color: '#111', lineHeight: 1.5 }}>
              {/* Шапка */}
              <div style={{ borderBottom: '2px solid #c05c2e', paddingBottom: 14, marginBottom: 22 }}>
