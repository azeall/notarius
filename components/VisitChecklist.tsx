          ...
          {checklists.map(c => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive ? 'rgb(var(--violet-rgb) / 0.14)' : 'rgb(var(--surface-rgb))',
            ...
            return (
              <li key={item.label}>
                <button
                  ...
                  style={{
                    background: isChecked ? 'rgb(var(--ok-rgb) / 0.10)' : 'rgba(0,0,0,0.02)',
                    borderColor: isChecked ? 'rgb(var(--ok-rgb) / 0.40)' : 'rgb(var(--violet-rgb) / 0.12)',
                  }}
                >
                  <span
