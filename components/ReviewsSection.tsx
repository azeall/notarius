...
const OTHER_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    platform: 'Яндекс',
    text: 'Замечательное место! Позвонила, записалась на тот же день, пришли с мамой на консультацию. Все ооочень грамотно объяснили, предложили варианты о которых мы не знали. За консультацию даже не взяли оплату — на нас потратили время, всё рассказали. Оформлять документы будем только тут.',
  },
  {
    author: 'Ростислав П.',
    date: 'сентябрь 2025',
  ...
  },
  {
    ...
    rating: 5,
    platform: 'Яндекс',
    text: 'Вызывала на дом, приехали нотариус и помощник: пунктуальные, вежливые, максимально корректные с пожилым дедушкой, аккуратно одетые. Девушка по телефону тоже вежливо всё рассказала и перезвонила сама, как договорились. Однозначно советую!',
  },
  {
    author: 'Галина Ч.',
    date: 'январь 2025',
    rating: 5,
    platform: 'Яндекс',
    text: 'Красивый просторный офис. Грамотное, вежливое и очень заботливое отношение. Супруг тоже был по своим вопросам и был приятно удивлён профессионализмом и скоростью работы.',
  },
  {
    author: 'мария',
    date: 'февраль 2026',
    rating: 5,
    platform: 'Яндекс',
    text: 'Очень качественный сервис! Делали доверенности и завещание. Всё обговорено, уточнено. Делают довольно быстро — 3 документа за 80–90 минут. Офис чистый, приятный. Много клиентов, лучше записаться заранее. Мы довольны!',
  },
  {
    author: 'Ася',
    date: 'март 2026',
