        ...
        <div className="flex items-end justify-between gap-10 mb-14 sm:mb-16 flex-wrap reveal">
          <div>
            ...
            {/* Пометка обязательна: отзывы сочинены, как и остальные данные образца.
                Рядом стоит средняя оценка и карточки со звёздами — без прямой
                оговорки это читается как слова живых людей, и отвечать за них
                пришлось бы нотариусу, показавшему сайт клиентам. */}
            <p className="mt-4 mb-0 text-[13px] leading-relaxed" style={{ color: '#8a9ab5' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[460px_1fr] gap-8 items-start reveal">
          ...
          <div className="flex flex-col gap-5 min-w-0">
            ...
            <div className="flex items-center gap-3 pt-3" style={{ borderTop: '1px solid rgba(184,154,90,0.10)' }}>
              ...
              <Stars n={5} />
              <span className="text-[12px]" style={{ color: '#6b7895' }}>средняя оценка · отзывы клиентов</span>
            </div>
          </div>
        </div>
      </div>
