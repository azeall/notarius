...
export default function SealCanvas({
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      ctx.save()
      ctx.rotate(P * MAX.l5)
      ctx.strokeStyle = 'rgba(111,102,214,0.15)'; ctx.lineWidth = 0.7
      ...
      // Monogram
      ctx.fillStyle = 'rgba(111,102,214,0.75)'
      ...
      if (shimmerActive) {
        ...
        band.addColorStop(0, 'rgba(111,102,214,0)')
        band.addColorStop(0.5, 'rgba(111,102,214,0.13)')
        band.addColorStop(1, 'rgba(111,102,214,0)')
        ctx.fillStyle = band
