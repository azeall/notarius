  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(192,92,46,0.05) 1px, transparent 1px),' +
            'linear-gradient(90deg, rgba(192,92,46,0.05) 1px, transparent 1px)',
          ...
          {CREDS.map((c, i) => (
            ...
            >
              <div
                ...
                style={{ background: 'radial-gradient(circle, rgba(192,92,46,0.18), transparent 70%)' }}
              >
                {c.icon}
              </div>
              <div
