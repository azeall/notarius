...
const INPUT_STYLE: React.CSSProperties = { background: 'rgb(var(--surface-rgb))', border: '1px solid rgba(29,158,117,0.20)' }
...
export default function AdminAddForm({ defaultStaffId }: { defaultStaffId?: string | null }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl p-4 sm:p-6 mb-8 sm:mb-10" style={{ background: 'rgb(var(--surface-rgb))', border: '1px solid rgba(29,158,117,0.15)' }}>
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              style={INPUT_STYLE}
            >
              {SERVICES.map(s => <option key={s} style={{ background: 'rgb(var(--surface-rgb))' }}>{s}</option>)}
            </select>
          </div>
          <div>
            ...
            <div
              ...
              style={
                !selectionFits || selectionConflicts
                  ...
                  : { background: 'rgba(29,158,117,0.10)', border: '1px solid rgba(29,158,117,0.25)', color: 'rgb(var(--text-rgb))' }
              }
            >
