          ...
          {faqs.map((faq, i) => (
            <div
              ...
              style={{
                ...
                ...(i === faqs.length - 1 ? { borderBottom: '1px solid rgba(192,92,46,0.10)' } : {}),
              }}
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ color: open === i ? '#d4763f' : 'rgb(var(--text-rgb))', transition: 'color .2s' }}
                >
                  {faq.q}
                </span>
                <span
                  ...
                  style={{
                    ...
                    background: open === i ? 'rgba(192,92,46,0.10)' : 'transparent',
                    borderColor: open === i ? 'rgb(var(--violet-rgb))' : 'rgba(192,92,46,0.30)',
                  }}
                >
