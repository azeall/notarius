    ...
    <section className="bg-navy-dark py-20 sm:py-24 md:py-[120px]">
      ...
      <div className="mx-auto px-5 sm:px-8 md:px-10" style={{ maxWidth: '1340px' }}>
        ...
        <div className="mb-10 sm:mb-16 reveal">
          ...
          >
            Часто задаваемые <em className="italic font-normal text-gold-ink">вопросы</em>
          </h2>
        </div>
          ...
          {faqs.map((faq, i) => (
            <div
              ...
              style={{
                ...
                ...(i === faqs.length - 1 ? { borderBottom: '1px solid rgba(29,158,117,0.10)' } : {}),
              }}
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ color: open === i ? '#27b585' : '#2c2c2c', transition: 'color .2s' }}
                >
                  {faq.q}
                </span>
                <span
