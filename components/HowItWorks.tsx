            ...
            >
              ...
              {i < STEPS.length - 1 && (
                <div
                  ...
                  style={{
                    ...
                    left: '4.5rem',
                    right: '-1rem',
                    background: 'linear-gradient(90deg, rgb(var(--violet-rgb) / 0.30), transparent)',
                  }}
                  aria-hidden
                />
              )}
              ...
              <div className="flex items-center gap-4 mb-6">
                <div
                  ...
                  style={{ background: 'rgb(var(--surface-rgb))', border: '1px solid rgb(var(--violet-rgb) / 0.18)', borderRadius: '12px' }}
                >
