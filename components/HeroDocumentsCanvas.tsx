...
export default function HeroDocumentsCanvas({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function drawDoc(d: Doc) {
      ...
      ctx.globalAlpha = 1; ctx.strokeStyle = 'rgba(212,118,63,0.22)'; ctx.lineWidth = 1
      ...
      ctx.globalAlpha = 0.25; ctx.fillStyle = 'rgba(212,118,63,1)'
    ...
    function drawSym(s: Sym) {
      ctx.save()
      ctx.globalAlpha = s.op; ctx.fillStyle = 'rgba(192,92,46,1)'
