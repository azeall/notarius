...
export default function HeroDocumentsCanvas({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function drawDoc(d: Doc) {
      ...
      ctx.globalAlpha = 1
      ctx.fillStyle = 'rgba(228,225,247,0.60)'
      ...
      ctx.strokeStyle = 'rgba(83,74,183,0.14)'
      ...
      ctx.globalAlpha = 1; ctx.strokeStyle = 'rgba(111,102,214,0.22)'; ctx.lineWidth = 1
      ...
      ctx.globalAlpha = 0.25; ctx.fillStyle = 'rgba(111,102,214,1)'
    ...
    function drawSym(s: Sym) {
      ctx.save()
      ctx.globalAlpha = s.op; ctx.fillStyle = 'rgba(83,74,183,1)'
