            ...
            <div className="space-y-5">
              <div>
                ...
                <select
                  ...
                  style={{ background: '#f4f3fd', border: '1px solid rgba(83,74,183,0.20)' }}
                >
              ...
              <div>
                ...
                <div className="rounded-xl p-4" style={{ background: '#f4f3fd', border: '1px solid rgba(83,74,183,0.12)' }}>
          ...
          {step === 2 && (
            <div className="space-y-4">
              <div
                ...
                style={{ background: '#f4f3fd', border: '1px solid rgba(83,74,183,0.12)' }}
              >
