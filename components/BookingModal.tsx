    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 24px 80px rgba(0,0,0,0.6), inset 0 1px 0 rgba(192,92,46,0.10)',
        }}
      ...
      >
        ...
        <div
          ...
          style={{ borderBottom: '1px solid rgba(192,92,46,0.12)' }}
        >
            ...
            <div className="space-y-5">
              <div>
                ...
                <select
                  ...
                  style={{ background: 'rgb(var(--bg-rgb))', border: '1px solid rgba(192,92,46,0.20)' }}
                >
              ...
              <div>
                ...
                <div className="rounded-xl p-4" style={{ background: 'rgb(var(--bg-rgb))', border: '1px solid rgba(192,92,46,0.12)' }}>
                    ...
                    {Array.from({ length: daysInMonth }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          `}
                          style={sel ? { background: 'rgb(var(--violet-rgb))' } : {}}
                        >
                          {d}
                        </button>
                      )
          ...
          {step === 2 && (
            <div className="space-y-4">
              <div
                ...
                style={{ background: 'rgb(var(--bg-rgb))', border: '1px solid rgba(192,92,46,0.12)' }}
              >
              ...
              <label className="flex items-start gap-2.5 cursor-pointer select-none">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 flex-shrink-0 accent-[#c05c2e] cursor-pointer"
                />
          ...
          {step === 3 && (
            <div className="text-center py-8 space-y-4">
              <div
                ...
                style={{ background: 'rgba(192,92,46,0.10)', border: '1px solid rgba(192,92,46,0.30)' }}
              >
