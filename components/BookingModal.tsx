            ...
            <div className="space-y-5">
              <div>
                ...
                <select
                  ...
                  style={{ background: '#f5ede0', border: '1px solid rgba(192,92,46,0.20)' }}
                >
              ...
              <div>
                ...
                <div className="rounded-xl p-4" style={{ background: '#f5ede0', border: '1px solid rgba(192,92,46,0.12)' }}>
          ...
          {step === 2 && (
            <div className="space-y-4">
              <div
                ...
                style={{ background: '#f5ede0', border: '1px solid rgba(192,92,46,0.12)' }}
              >
