...
export default function BookingModal(props: BookingModalProps) {
  // Live requests use the external notariusbot widget, never the nonexistent local API.
  if (LIVE_BOOKING) return null
  return <DemoBookingModal {...props} />
}

function DemoBookingModal({ onClose, initialDate, initialTime }: BookingModalProps) {
  ...
  const modal = (
    ...
    >
      <div
        ...
        style={{
          background: '#0f1e35',
          border: '1px solid rgb(184 154 90 / 0.30)',
          boxShadow: '0 24px 80px rgba(0,0,0,0.6), inset 0 1px 0 rgb(184 154 90 / 0.10)',
        }}
      ...
      >
        ...
        <div
          ...
          style={{ borderBottom: '1px solid rgb(184 154 90 / 0.12)' }}
        >
            ...
            <div className="space-y-5">
              <div>
                ...
                <select
                  ...
                  style={{ background: '#0a1628', border: '1px solid rgb(184 154 90 / 0.20)' }}
                >
              ...
              <div>
                ...
                <div className="rounded-xl p-4" style={{ background: '#0a1628', border: '1px solid rgb(184 154 90 / 0.12)' }}>
          ...
          {step === 2 && (
            <div className="space-y-4">
              <div
                ...
                style={{ background: '#0a1628', border: '1px solid rgb(184 154 90 / 0.12)' }}
              >
              ...
              <label className="flex items-start gap-2.5 cursor-pointer select-none">
                ...
                <span className="text-[12px] text-slate leading-snug">
                  ...
                  <a href="/consent" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-light underline underline-offset-2">
                    текст согласия
              ...
              <div className="flex gap-3 pt-1">
                <button
                  ...
                  style={{ border: '1px solid rgb(184 154 90 / 0.20)' }}
                >
                  ← Назад
                </button>
                <button
          ...
          {step === 3 && (
            <div className="text-center py-8 space-y-4">
              <div
                ...
                style={{ background: 'rgb(184 154 90 / 0.10)', border: '1px solid rgb(184 154 90 / 0.30)' }}
              >
