    ...
    <div className="cf-wrap">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .cf-tip{position:absolute;right:62px;top:50%;transform:translateY(-50%);
          background:rgb(var(--text-rgb));color:rgb(var(--bg-rgb));font-size:12px;font-weight:600;white-space:nowrap;
        ...
        .cf-main{position:relative;width:60px;height:60px;border-radius:50%;border:none;cursor:pointer;color:#fff;
          ...
          box-shadow:0 10px 26px rgb(var(--text-rgb) / .28);display:grid;place-items:center;
          transition:transform .25s cubic-bezier(.2,.7,.2,1);}
        .cf-main::after{content:'';position:absolute;inset:0;border-radius:50%;
          border:2px solid rgb(var(--text-rgb) / .45);animation:cfpulse 2.4s ease-out infinite;}
        .cf-main:hover{transform:scale(1.05);background:rgb(var(--violet-rgb));}
