...
export default function ContactFab() {
  ...
  const items = [
    { label: notary.phone, href: notary.phoneHref, bg: '#1D9E75', icon: ICON.ph },
    ...
    <div className="cf-wrap">
      ...
      <style>{`
        ...
        .cf-item{opacity:0;visibility:hidden;transform:translateY(12px) scale(.6);
          ...
          box-shadow:0 8px 20px rgba(44,44,44,.25);text-decoration:none;position:relative;
        ...
        .cf-tip{position:absolute;right:62px;top:50%;transform:translateY(-50%);
          background:#2c2c2c;color:#fff;font-size:12px;font-weight:600;white-space:nowrap;
        ...
        .cf-main{position:relative;width:60px;height:60px;border-radius:50%;border:none;cursor:pointer;color:#fff;
          background:linear-gradient(135deg,#27b585,#1D9E75);
          box-shadow:0 12px 30px rgba(29,158,117,.45);display:grid;place-items:center;
          transition:transform .25s cubic-bezier(.2,.7,.2,1);}
        .cf-main::after{content:"";position:absolute;inset:0;border-radius:50%;
          border:2px solid rgba(29,158,117,.55);animation:cfpulse 2.4s ease-out infinite;}
