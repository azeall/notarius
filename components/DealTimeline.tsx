      ...
      <div className="mx-auto px-5 sm:px-10" style={{ maxWidth: '1000px' }}>
        ...
        <div className="relative mb-9 reveal">
          ...
          <span
            ...
            style={{ background: '#c05c2e', width: `${(active / (STEPS.length - 1)) * 100}%`, transition: 'width .4s cubic-bezier(0.2,0.7,0.2,1)' }}
            aria-hidden
          />
          <div className="relative grid" style={{ gridTemplateColumns: `repeat(${STEPS.length}, 1fr)` }}>
            {STEPS.map((s, i) => {
              ...
              return (
                <button key={s.t} onClick={() => setActive(i)} className="flex flex-col items-center gap-2 group">
                  <span
                    ...
                    style={{
                      ...
                      boxShadow: i === active ? '0 0 0 5px rgba(192,92,46,0.16)' : 'none',
                    }}
                  >
                    {i < active ? '✓' : i + 1}
                  </span>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="rounded-xl px-6 py-2.5 text-sm font-semibold text-white transition-all hover:brightness-110 disabled:opacity-35"
