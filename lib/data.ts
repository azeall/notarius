...
export const notary = {
  name: 'Иванова Мария Сергеевна',            // ФИО нотариуса
  title: 'Нотариус города Москвы',
  address: 'ул. Тверская, 18к1, Москва',    // Полный адрес
  addressParts: {
  ...
  practiceSince: '2011',                      // Год начала практики, напр. '2014' (пусто — не показывать)
  license: '№ 77/318-н',                            // Номер лицензии, напр. '№ 77/123'
