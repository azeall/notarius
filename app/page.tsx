...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="relative py-20 sm:py-[120px]" style={{ background: '#ffffff' }}>
        <div className="relative mx-auto px-5 sm:px-8 md:px-10" style={{ maxWidth: '1340px' }}>
          ...
          <div
            ...
            style={{ border: '1px solid rgba(29,158,117,0.15)', background: 'rgba(29,158,117,0.12)' }}
          >
            {/* Info column */}
            <div style={{ padding: '44px 40px', background: '#ffffff' }}>
              ...
              {[
                ...
                <div
                  ...
                  style={{ borderTop: '1px solid rgba(29,158,117,0.08)' }}
                >
                  <div
                    className="font-mono text-[10px] tracking-[0.2em] uppercase pt-0.5 flex-shrink-0"
                    style={{ color: 'rgba(29,158,117,0.70)', minWidth: '72px' }}
                  >
                    {row.k}
                  </div>
            ...
            {/* Map column */}
            <div className="relative" style={{ minHeight: '380px', background: '#ffffff' }}>
              <iframe
      ...
      <section
        ...
        style={{
          background: '#e8f5f0',
          borderTop: '1px solid rgba(29,158,117,0.10)',
        }}
      >
        {/* Gold grid */}
        <div
