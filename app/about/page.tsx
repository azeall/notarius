...
const VALUES = [
  ...
  },
  {
    ...
    text: 'Многолетняя практика и постоянное повышение квалификации гарантируют грамотное и качественное оформление любых документов.',
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-2 space-y-6 text-slate leading-relaxed">
              ...
              <p>
                Нотариальная контора обслуживает физических лиц, предпринимателей и организации. Каждое нотариальное
                действие совершается с соблюдением всех требований закона, что гарантирует юридическую силу
            ...
            <div className="space-y-5">
              <div className="bg-navy-card text-cream rounded-2xl p-6" style={{ border: '1px solid rgba(29,158,117,0.18)' }}>
              ...
              <div className="rounded-2xl p-5 space-y-3" style={{ background: '#ffffff', border: '1px solid rgba(29,158,117,0.15)' }}>
      ...
      <section className="bg-navy-dark border-t" style={{ borderColor: 'rgba(29,158,117,0.12)' }}>
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {VALUES.map(v => (
              <div key={v.title} className="rounded-2xl p-6 transition-all hover:-translate-y-0.5" style={{ background: '#ffffff', border: '1px solid rgba(29,158,117,0.15)' }}>
