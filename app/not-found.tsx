    ...
    <section className="nf">
      ...
      <style>{`
        .nf{position:relative;min-height:72vh;display:flex;align-items:center;justify-content:center;
          padding:120px 22px 80px;background:#f4f3fd;overflow:hidden;text-align:center;}
        .nf-bg{position:absolute;inset:0;pointer-events:none;
          background:
            radial-gradient(60% 60% at 50% 30%, rgba(83,74,183,.10), transparent 70%),
        ...
        .nf-mark{font-family:var(--font-playfair),Georgia,serif;font-weight:700;line-height:1;
          ...
          background:linear-gradient(176deg,#6f64d4,#534AB7 55%,#403988);
        ...
        .nf-seal{position:absolute;top:8%;left:50%;transform:translate(-50%,-30%);
          ...
          font-family:var(--font-playfair),Georgia,serif;font-size:54px;color:#534AB7;
          border:2px solid rgba(200,178,126,.5);background:rgba(255,255,255,.35);
          box-shadow:inset 0 0 0 6px rgba(83,74,183,.08);opacity:.18;}
        .nf-title{font-family:var(--font-playfair),Georgia,serif;font-weight:600;color:#2f2a63;
          font-size:clamp(26px,4vw,40px);margin:6px 0 0;}
        .nf-title em{font-style:italic;font-weight:400;color:#534AB7;}
        ...
        .nf-btn{display:inline-flex;align-items:center;padding:14px 30px;border-radius:14px;
          ...
          background:linear-gradient(135deg,#6f64d4,#534AB7);box-shadow:0 12px 28px rgba(83,74,183,.35);
          transition:transform .2s;}
        .nf-btn:hover{transform:translateY(-2px);}
        .nf-phone{color:#534AB7;font-weight:600;text-decoration:none;border-bottom:1px solid rgba(83,74,183,.3);padding-bottom:2px;}
      `}</style>
    </section>
  )
}
