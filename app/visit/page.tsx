...
export default function VisitPage() {
  return (
    <>
      ...
      {/* Steps */}
      <section className="bg-navy border-b" style={{ borderColor: 'rgba(29,158,117,0.12)' }}>
        <div className="max-w-6xl mx-auto px-4 py-14">
          <div className="grid md:grid-cols-3 gap-6">
            {STEPS.map(s => (
              <div key={s.n} className="relative">
                <span className="font-serif text-5xl font-bold" style={{ color: 'rgba(29,158,117,0.30)' }}>{s.n}</span>
      ...
      {/* Notes */}
      <section className="bg-navy border-t" style={{ borderColor: 'rgba(29,158,117,0.12)' }}>
        <div className="max-w-6xl mx-auto px-4 py-14">
