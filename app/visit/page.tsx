...
export default function VisitPage() {
  return (
    <>
      ...
      {/* Steps */}
      <section className="bg-navy border-b" style={{ borderColor: 'rgba(83,74,183,0.12)' }}>
        <div className="max-w-6xl mx-auto px-4 py-14">
          <div className="grid md:grid-cols-3 gap-6">
            {STEPS.map(s => (
              <div key={s.n} className="relative">
                <span className="font-serif text-5xl font-bold" style={{ color: 'rgba(83,74,183,0.30)' }}>{s.n}</span>
          ...
          <div className="grid sm:grid-cols-2 gap-x-10 gap-y-8">
            {NOTES.map(n => (
              <div key={n.title} className="flex gap-4">
                <span className="w-9 h-9 rounded-lg grid place-items-center flex-shrink-0 text-gold" style={{ background: 'rgba(83,74,183,0.10)' }}>
