    ...
    <>
      ...
      <section className="relative bg-navy text-cream overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-20">
          <p className="text-gold-ink uppercase tracking-widest text-xs font-semibold mb-3">Полезные материалы</p>
      ...
      <section className="bg-navy-dark">
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <Link
            ...
            style={{ background: 'rgb(var(--surface-rgb))', border: '1px solid rgba(29,158,117,0.18)' }}
          >
            <div className="grid md:grid-cols-[1.1fr_1fr]">
              <div className="p-8 md:p-10 flex flex-col justify-center">
                ...
                <h2 className="font-serif text-2xl md:text-3xl font-bold text-cream leading-tight mb-3 group-hover:text-gold-ink transition-colors">
                  {featured.title}
                </h2>
                <p className="text-slate text-sm leading-relaxed mb-5">{featured.excerpt}</p>
                <span className="inline-flex items-center gap-2 text-sm font-semibold text-gold-ink">
                  Читать статью
              ...
              {/* Decorative panel */}
              <div className="relative min-h-[200px] hidden md:block overflow-hidden" style={{ background: 'rgb(var(--surface-rgb))' }}>
                <div
                  ...
                  aria-hidden
                />
                <svg className="absolute inset-0 m-auto w-20 h-20 text-gold-ink/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
