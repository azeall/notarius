        ...
        <div className="space-y-3 mb-4">
          ...
          <div>
            ...
            <input
              ...
              autoFocus
              autoComplete="off"
              className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold bg-gray-50 text-gray-900 placeholder:text-gray-400"
            />
          </div>
