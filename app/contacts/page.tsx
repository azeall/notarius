            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <a
                  ...
                  style={{ background: 'rgb(var(--surface-rgb))', border: '1px solid rgba(83,74,183,0.20)' }}
                >
                ...
                <div className="flex items-center gap-4 rounded-2xl px-6 py-5" style={{ background: 'rgb(var(--surface-rgb))', border: '1px solid rgba(83,74,183,0.15)' }}>
