          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                >
                  <div className="w-10 h-10 rounded-lg grid place-items-center flex-shrink-0 text-gold" style={{ background: 'rgb(var(--violet-rgb) / 0.12)' }}>
                ...
                <a
                  ...
                  className="flex items-center gap-4 rounded-2xl px-6 py-5 transition-all hover:-translate-y-0.5 group"
                  style={{ background: 'rgb(var(--surface-rgb))', border: '1px solid rgb(var(--ok-rgb) / 0.30)' }}
                >
                  <div className="w-10 h-10 rounded-lg grid place-items-center flex-shrink-0" style={{ background: 'rgb(var(--ok-rgb) / 0.15)', color: 'rgb(var(--ok-2-rgb))' }}>
                ...
                <div className="flex items-center gap-4 rounded-2xl px-6 py-5" style={{ background: 'rgb(var(--surface-rgb))', border: '1px solid rgb(var(--violet-rgb) / 0.15)' }}>
                  <div className="w-10 h-10 rounded-lg grid place-items-center flex-shrink-0 text-gold" style={{ background: 'rgb(var(--violet-rgb) / 0.10)' }}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Map */}
              <div className="rounded-2xl overflow-hidden h-72" style={{ border: '1px solid rgb(var(--violet-rgb) / 0.20)' }}>
                <iframe
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div
                  ...
                  style={{ color: 'rgb(var(--violet-rgb) / 0.25)' }}
                >
                  [ фото нотариуса ]
                </div>
              </div>
