          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <a
                  ...
                  style={{ background: '#ffffff', border: '1px solid rgba(29,158,117,0.20)' }}
                >
                ...
                <div className="flex items-center gap-4 rounded-2xl px-6 py-5" style={{ background: '#ffffff', border: '1px solid rgba(29,158,117,0.15)' }}>
            ...
            <div className="space-y-4">
              ...
              >
                {/* Corner brackets */}
                {[
                  { top: 8, left: 8, borderTop: '1px solid #1D9E75', borderLeft: '1px solid #1D9E75' },
                  { top: 8, right: 8, borderTop: '1px solid #1D9E75', borderRight: '1px solid #1D9E75' },
                  { bottom: 8, left: 8, borderBottom: '1px solid #1D9E75', borderLeft: '1px solid #1D9E75' },
                  { bottom: 8, right: 8, borderBottom: '1px solid #1D9E75', borderRight: '1px solid #1D9E75' },
                ].map((s, i) => (
                  <div
                    key={i}
                    className="absolute"
                ...
                {/* Silhouette icon */}
                <div className="mb-3" style={{ color: 'rgba(29,158,117,0.20)' }}>
                ...
                <p
                  ...
                  style={{ fontSize: '17px', lineHeight: '1.2', color: '#1D9E75' }}
                >
                ...
                <div
                  ...
                  style={{ color: 'rgba(29,158,117,0.25)' }}
                >
                  [ фото нотариуса ]
                </div>
              </div>
