          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <a
                  ...
                  style={{ background: '#ffffff', border: '1px solid rgba(83,74,183,0.20)' }}
                >
                  <div className="w-10 h-10 rounded-lg grid place-items-center flex-shrink-0 text-gold" style={{ background: 'rgba(83,74,183,0.12)' }}>
                ...
                <a
                  ...
                  className="flex items-center gap-4 rounded-2xl px-6 py-5 transition-all hover:-translate-y-0.5 group"
                  style={{ background: '#ffffff', border: '1px solid rgba(79,157,122,0.30)' }}
                >
                  ...
                  <div>
                    ...
                    <p className="font-semibold" style={{ color: '#6fbf99' }}>Написать сейчас</p>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-4 rounded-2xl px-6 py-5 transition-all hover:-translate-y-0.5 group"
                  style={{ background: '#ffffff', border: '1px solid rgba(96,165,250,0.30)' }}
                >
                ...
                <div className="flex items-center gap-4 rounded-2xl px-6 py-5" style={{ background: '#ffffff', border: '1px solid rgba(83,74,183,0.15)' }}>
                  <div className="w-10 h-10 rounded-lg grid place-items-center flex-shrink-0 text-gold" style={{ background: 'rgba(83,74,183,0.10)' }}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Map */}
              <div className="rounded-2xl overflow-hidden h-72" style={{ border: '1px solid rgba(83,74,183,0.20)' }}>
                <iframe
            ...
            <div className="space-y-4">
              ...
              <div
                ...
                style={{ padding: '32px 24px', background: '#ffffff', minHeight: '200px' }}
              >
                {/* Corner brackets */}
                {[
                  { top: 8, left: 8, borderTop: '1px solid #534AB7', borderLeft: '1px solid #534AB7' },
                  { top: 8, right: 8, borderTop: '1px solid #534AB7', borderRight: '1px solid #534AB7' },
                  { bottom: 8, left: 8, borderBottom: '1px solid #534AB7', borderLeft: '1px solid #534AB7' },
                  { bottom: 8, right: 8, borderBottom: '1px solid #534AB7', borderRight: '1px solid #534AB7' },
                ].map((s, i) => (
                  <div
                    key={i}
                    className="absolute"
                ...
                {/* Silhouette icon */}
                <div className="mb-3" style={{ color: 'rgba(83,74,183,0.20)' }}>
                ...
                <p
                  ...
                  style={{ fontSize: '17px', lineHeight: '1.2', color: '#534AB7' }}
                >
                ...
                <div
                  ...
                  style={{ color: 'rgba(83,74,183,0.25)' }}
                >
                  [ фото нотариуса ]
                </div>
              </div>
